...
load 'presentation/become_to_zero_vacant_payload_builder.rb'
load 'presentation/all_vacants_payload_builder.rb'
...
load 'test/presentation/become_to_zero_vacant_payload_builder_test.rb'
load 'test/presentation/all_vacants_payload_builder_test.rb'
